...
const backendUrl =
  process.env.INTERNAL_ORDER_API_BASE_URL || "http://backend:8080";
...
const isSocket = (pathname: string) =>
...
server.listen(port, hostname, () => {
  console.log(
    `Order web listening on http://${hostname}:${port}; backend proxy: ${backendUrl}`,
  );
});
