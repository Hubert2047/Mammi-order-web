...
const detectLocale = (): Locale => { if (typeof navigator === 'undefined') return 'vi'; const saved = window.localStorage.getItem('mammi-order-locale'); if (saved === 'vi' || saved === 'en' || saved === 'zh-TW') return saved; const language = navigator.language.toLowerCase(); if (language.startsWith('zh')) return 'zh-TW'; if (language.startsWith('en')) return 'en'; return 'vi' }
