...
export default function CartPanelHeader({
    ...
    return (
        <div className={`flex items-center justify-between gap-3 border-b border-gray-100 px-6 pb-[10px] pt-5 font-['Segoe_UI','Helvetica_Neue',Arial,sans-serif] text-[1.05rem] text-[#24312a] ${className}`}>
            ...
            <button
                ...
                <span className='block translate-x-px -translate-y-[3px] text-[1.6rem]'>×</span>
            </button>
        </div>
    )
}
